...
private class GetPollingUnits extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            Log.d(TAG, "URL in backround: " + url);
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    SearchResult.this, PUList,
                    R.layout.search_row_layout, new String[]{TAG_ID, TAG_DESC,}, new int[]{R.id.PUID_search,
                    R.id.PULocation_search,});
